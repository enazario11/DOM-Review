...
soc_freq <- codes_vars2 %>%
  subset(select = c("Resource availability", "Pre existing conditions", "Adoption incentives", "Feasibility", "Co management and communication", "Indirect socioeconomic consequences", "Lack of political administration permanence", "Implementation costs", "Poor communication and outreach", "Poor program implementation")) %>%
